/**
 * wiki-utils.js?v=19 — Shared utilities for wiki editing and rendering.
 * Requires site-config.js?v=19 to be loaded first (uses SITE.REPO, SITE.getSession).
 *
...
(function () {
   ...
   * Version strings (theme.css?v=19 inject-navbar.js?v=19 inject-sidebar.js?v=19
...
<head>
  ...
  <link rel="stylesheet" href="/components/themes/theme.css?v=19" />
</head>
<body>
  ...
  <script src="/components/site-config.js?v=19"></script>
  <script src="/components/navbar/inject-navbar.js?v=19" defer></script>
  <script src="/components/sidebar/inject-sidebar.js?v=19" defer></script>
</body>
</html>`;
  }
