/**
 * wiki-utils.js?v=16 — Shared utilities for wiki editing and rendering.
 * Requires site-config.js?v=16 to be loaded first (uses SITE.REPO, SITE.getSession).
 *
...
(function () {
   ...
   * Version strings (theme.css?v=16 inject-navbar.js?v=16 inject-sidebar.js?v=16
...
<head>
  ...
  <link rel="stylesheet" href="/components/themes/theme.css?v=16" />
</head>
<body>
  ...
  <script src="/components/site-config.js?v=16"></script>
  <script src="/components/navbar/inject-navbar.js?v=16" defer></script>
  <script src="/components/sidebar/inject-sidebar.js?v=16" defer></script>
</body>
</html>`;
  }
