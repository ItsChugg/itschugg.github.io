/**
 * wiki-utils.js?v=32 — Shared utilities for wiki editing and rendering.
 * Requires site-config.js?v=32 to be loaded first (uses SITE.REPO, SITE.getSession).
 *
...
<head>
  ...
  <link rel="stylesheet" href="/components/themes/theme.css?v=32" />
  <script src="/components/site-config.js?v=32"><\/script>
  <script src="/components/navbar/inject-navbar.js?v=32" defer><\/script>
  <script src="/components/sidebar/inject-sidebar.js?v=32" defer><\/script>
</head>
<body>
   ...
   * Version strings (theme.css?v=32 inject-navbar.js?v=32 inject-sidebar.js?v=32
