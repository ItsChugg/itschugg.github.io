/**
 * wiki-utils.js?v=20 — Shared utilities for wiki editing and rendering.
 * Requires site-config.js?v=20 to be loaded first (uses SITE.REPO, SITE.getSession).
 *
...
(function () {
   ...
   * Version strings (theme.css?v=20 inject-navbar.js?v=20 inject-sidebar.js?v=20
...
<head>
  ...
  <link rel="stylesheet" href="/components/themes/theme.css?v=20" />
</head>
<body>
  ...
  <script src="/components/site-config.js?v=20"></script>
  <script src="/components/navbar/inject-navbar.js?v=20" defer></script>
  <script src="/components/sidebar/inject-sidebar.js?v=20" defer></script>
</body>
</html>`;
  }
