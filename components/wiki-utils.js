/**
 * wiki-utils.js?v=5 — Shared utilities for wiki editing and rendering.
 * Requires site-config.js?v=5 to be loaded first (uses SITE.REPO, SITE.getSession).
 *
...
(function () {
   ...
   * Version strings (theme.css?v=5 inject-navbar.js?v=5 inject-sidebar.js?v=5
...
<head>
  ...
  <link rel="stylesheet" href="/components/themes/theme.css?v=5" />
</head>
<body>
  ...
  <script src="/components/site-config.js?v=5"></script>
  <script src="/components/navbar/inject-navbar.js?v=5" defer></script>
  <script src="/components/sidebar/inject-sidebar.js?v=5" defer></script>
</body>
</html>`;
  }
